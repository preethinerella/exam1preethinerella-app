# -*- coding: utf-8 -*-
"""Exam1Part2_Starter(ANS).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/19fJeayqNNnMqb47-pgP9wrkAJmgL57gg
...
path='/content/CleanedAutomobile.csv'
df = pd.read_csv(path)
df.head()
...
df = df.astype({'bore': float, 'stroke': float, 'price': float, 'peak-rpm': float, 'horsepower': float})
...
# Write your code below and press Shift+Enter to execute
# Calculate correlation again (if needed)
correlation_stroke_price = df[["stroke", "price"]].corr()
print("Correlation between stroke and price:\n", correlation_stroke_price)

# Visual verification using regplot
sns.regplot(x="stroke", y="price", data=df)
plt.title("Regression Plot: Stroke vs Price")
plt.show()
...
# Write your code below and press Shift+Enter to execute
avg_price_by_body_style = df[["body-style", "price"]].groupby("body-style", as_index=False).mean()
